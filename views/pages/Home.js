...
import Adorations from '../pages/Adoration'
import Testimonys from '../pages/Testimony'
  ...
  render() {
    ...
    return <View style={styles.container}>
      ...
      <View style={styles.navigation}>
        <HomeNavigation navigate={this.props.navigation.navigate} items={["Accueil","Evenements","Ministries"]} position={0}/>
      </View>

...
class HomeItem extends Component {
  render() {
    return <View style={styles.container}>
        ...
        <Text style={styles.url}>{this.props.item.url&&this.props.item.url.substr(13)}</Text>
        <Image source={this.props.item.mediaURI} style={{width:'100%',height:300}} resizeMode="cover"/>
